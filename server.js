...
const log = client.channels.get('566386000729866240') // Logging channel

const serverStats = {
  guildID: '566237915198259240',
  totalUsersID: '471602694436683786',
  memberCountID: '471602835495190528',
  botCountID: '471602889974874113'
}

var ownerId = '223533056852623360'; //My ID
...
client.on('ready', () => { //Startup
  console.log("Bot on!");
  client.user.setUsername("MasterBot");
...
client.on('guildCreate', guild => { // If the Bot was added on a server, proceed
  ...
  var welcome = new Discord.RichEmbed()
    .setColor(0x000000)
    .setURL("https://discord.gg/6HqqqcH")
    .setTitle("Joined " + guild.name + " | Click to join support server")
    .setDescription("**Well, hello, I think.**\n\nMy name is MasterBot, as you can see. I'm just a bot. Perfect bot. Another, same as other millions bots.\n\n")
    ...
    .setFooter("Members: " + guild.memberCount + " | Guild: " + guild.name + " | Use #help to get help information | Official website: MasterBot.glitch.me");
